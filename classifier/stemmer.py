    ...
    def __init__(self):
        ...
        self.suffixes={
            ...
            3: [
                            ...
                            'नन्', 'िया', 'झैँ', 'न्छ', 'ेका','एको', 'ेको', 'शील',
                            'सार', 'ालु', 'ईन्', 'ीन्', 'िलो', 'ाडी'
                ],
            4: [
                            'छेस्', 'छ्यौ', 'ँछन्', 'छिन्', 'थ्यौ', 'थिन्','औंला',
                            'ौंला', 'लिन्', 'लान्','लास्','लिस्', 'होस्', 'माथी',
                            'तर्फ', 'मुनि', 'पर्छ', 'ियाँ', 'न्छौ', 'सम्म','ाएको',
                            'सुकै', 'यालु', 'डालु', 'उँला', 'ुँला'
                ],
            5: [
